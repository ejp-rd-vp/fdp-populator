...
### Status
Metadata fields for dataset resources have been successfuly tested by SHACL validation. Several limitations still exist due to metadata schema discrepancies. FDP API interaction not tested yet.
